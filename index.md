...
venue: "USGS"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "June 11,13,18,20 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 am - 1:00 pm MT (11:00 am - 3:00 pm ET)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Saira Haider", "Steve Formel", "Paul Selmants"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Olivia Pearman", "Margaux Sleckman", "Courtney Killian", "Matt Neilson", "Victoria Scholl", "Carl Norlen", "Derek Friend", "Gavin Cotterill", "James White", "Bryan McCloskey", "Scott Brown", "Dylan Gomes"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://doimspp.sharepoint.com/:w:/r/sites/CommunityforDataIntegration/Carpentries/202406_Software_Carpentries_Notes.docx?d=wb0bc830b8d894f889f95b5bf07c49563&csf=1&web=1&e=8BiCbp # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
...
<p id="requirements">
  ...
  {% else %}
    ...
    Mac, Linux, or Windows operating system (not a tablet, Chromebook, etc.) This may require asking IT to do the installations, which must be completed before beginning the course.
  {% endif %}
